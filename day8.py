fil = ["bceadfg ebcdaf gdaecf fgcaeb fdbea fcdea cbda begdf afb ba | acfbeg cbfgea gebacf ab",
...
for r in fil:
    ...
    for char in numbers[4]:
        if char not in numbers[1]:
            fourDiff = fourDiff+char
    
    for n in tot:
        if len(n) == 5:
            if numbers[1][0] in n and numbers[1][1] in n:
                numbers[3] = n
            elif fourDiff[0] in n and fourDiff[1] in n:
                numbers[5] = n
            else: 
                numbers[2] = n 
        elif len(n) == 6:
            if numbers[4][0] in n and numbers[4][1] in n and numbers[4][2] in n and numbers[4][3] in n:
                numbers[9]= n
            elif fourDiff[0] in n and fourDiff[1] in n:
                numbers[6] = n
            else:
